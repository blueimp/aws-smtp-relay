...
func initCliArgs() Config {
	ret := Config{}
	pflag.BoolVar(&ret.Enable, "SES.ObserverEnable", false, "Enable AWS SES Observer")
	...
	pflag.BoolVar(&ret.Smtp.ConnectionTLS, "SES.Smtp.ConnectionTLS", false, "Observer Relay SMTP Connection TLS")
	pflag.BoolVar(&ret.Smtp.ForceSTARTTLS, "SES.Smtp.ForceSTARTTLS", true, "Observer Relay SMTP Force STARTTLS")
	pflag.BoolVar(&ret.Smtp.InsecureTLS, "SES.Smtp.InsecureTLS", true, "Observer Relay SMTP Insecure TLS(Certs)")
